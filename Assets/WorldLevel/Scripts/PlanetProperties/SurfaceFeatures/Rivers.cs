...
public class Rivers : PropertyDecorator {
    ...
    public Rivers() : base(Rivers.NAME) {
        this.tileProperties = Rivers.generateDefaultTileHeightProperties();
    }
    ...
    public override void generateTile(Tile t, int x, int y) {
        ...
        t.setData(Rivers.NAME, heightProperty);
        ...
        t.setDataBitmask(Rivers.NAME, bitmask);
    }
...
public class Height : DataBucket {
    ...
    public static Height getHeightForTile(Tile tile) {
        return (Height)tile.getData(Rivers.NAME);
    }
}
