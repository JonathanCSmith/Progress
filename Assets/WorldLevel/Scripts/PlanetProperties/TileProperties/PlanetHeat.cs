...
public class HeatPlanetProperty : PlanetPropertyGenerator {
    ...
    public HeatPlanetProperty() : base(HeatPlanetProperty.NAME) {
        this.tileProperties = HeatPlanetProperty.generateDefaultTileHeatProperties();
        this.heightClassificationModifiers = HeatPlanetProperty.generateDefaultHeatClassificationModifiers();
    }
...
public class Heat : DataBucket {
    ...
    public static Heat getHeat(Tile tile) {
        return (Heat)tile.getData(HeatPlanetProperty.NAME);
    }

    public static void setHeat(Tile tile, Heat heat) {
        tile.setData(HeatPlanetProperty.NAME, heat);
    }
}
