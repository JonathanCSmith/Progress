...
public class HeightPlanetProperty : PlanetPropertyGenerator {
    ...
    public HeightPlanetProperty() : base(HeightPlanetProperty.NAME) {
    ...
    public override void generateTile(Tile t, int x, int y) {
        ...
        t.setData(HeightPlanetProperty.NAME, heightProperty);
        ...
        t.setDataBitmask(HeightPlanetProperty.NAME, bitmask);
    }
...
public class Height : DataBucket {
    ...
    public static Height getHeightForTile(Tile tile) {
        return (Height)tile.getData(HeightPlanetProperty.NAME);
    }
}
